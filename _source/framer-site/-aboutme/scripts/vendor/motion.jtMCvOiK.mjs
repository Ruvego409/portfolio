...
function We(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(xc)?.length || 0) + (e.match(Pc)?.length || 0) > 0
  );
}
function Ge(e) {
  let t = e.toString(),
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          G.test(e)
            ? (r.color.push(a), i.push(Ic), n.push(G.parse(e)))
            : e.startsWith(Rc)
              ? (r.var.push(a), i.push(Lc), n.push(e))
              : (r.number.push(a), i.push(Fc), n.push(parseFloat(e))),
          ++a,
          zc
        )
      )
...
function qe({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Fc ? (i += bc(r[a])) : e === Ic ? (i += G.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function Ye(e) {
  let t = Ge(e);
  return qe(t)(t.values.map((e, n) => Hc(e, t.split[n])));
}
function Xe(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function mt(e = J.visualDuration, t = J.bounce) {
  ...
  let ee = {
    ...
    toString: () => {
      let e = Math.min(st(ee), Xc),
        t = Yc((t) => ee.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function _t(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = Ls(Array.isArray(t) ? t[n] || F : t, a)), r.push(a));
  }
  return r;
}
...
function Mt() {
  if (wl) {
    let e = Array.from(Sl).filter((e) => e.needsMeasurement),
  ...
  ((wl = !1), (Cl = !1), Sl.forEach((e) => e.complete(Tl)), Sl.clear());
}
function Nt() {
  Sl.forEach((e) => {
...
function Bt({ type: e, ...t }) {
  return zt(e) && jl() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Vt(e) {
  return e in Fl;
}
function Ht(e) {
  typeof e.ease == `string` && Vt(e.ease) && (e.ease = Fl[e.ease]);
}
function Ut(e) {
  ((e.duration = 0), (e.type = `keyframes`));
}
function Wt(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == `string` && zl.test(e[t])) return !0;
  return !1;
}
function Gt(e) {
  let {
...
function Qt(e) {
  for (let t in e) if (!nu.has(t)) return !0;
  return !1;
}
function $t(e) {
  let t = iu.exec(e);
...
function pn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(ru(t, r, i, h && au.has(t) ? { type: !1 } : o, e, m));
    let g = r.animation;
    g && d.push(g);
  }
  if (o) {
...
function vn(e, t) {
  let n = bu(e);
  return (xu.has(n) || (n = K), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function yn(e) {
  return typeof e == `number` ? e === 0 : e === null || e === `none` || e === `0` || Is(e);
}
function bn(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i;) {
    let t = e[r];
    (typeof t == `string` && !Su.has(t) && Ge(t).values.length && (i = e[r]), r++);
  }
...
function kn(e) {
  return ju.has(e.tagName) || e.isContentEditable === !0;
}
function An(e) {
  return (t) => {
    t.key === `Enter` && e(t);
...
function Nn(e, t, n = {}) {
  let [r, i, a] = Tn(e, n),
    o = (e) => {
      ...
      if (!Mn(e) || Pu.has(e)) return;
      (Mu.add(r), n.stopPropagation && Pu.add(e));
      let a = t(r, e),
        o = { ...i, capture: !0 },
        s = (e, t) => {
        ...
        c = (e) => {
          s(e, r === f || r === document || n.useGlobalTarget || Ou(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
  ...
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? f : e).addEventListener(`pointerdown`, o, i),
        Sn(e) &&
          (e.addEventListener(`focus`, (e) => Nu(e, i)),
...
function Ln() {
  typeof ResizeObserver > `u` || (Iu = new ResizeObserver(In));
}
function Rn(e, t) {
  Iu || Ln();
  let n = xn(e);
  return (
    n.forEach((e) => {
      let n = Fu.get(e);
      (n || ((n = new Set()), Fu.set(e, n)), n.add(t), Iu?.observe(e));
    }),
    () => {
      n.forEach((e) => {
        let n = Fu.get(e);
        (n?.delete(t), n?.size || Iu?.unobserve(e));
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      (Bu.delete(e),
        !Bu.size &&
          typeof Vu == `function` &&
          (f.removeEventListener(`resize`, Vu), (Vu = void 0)));
    }
  );
}
function Vn(e, t) {
...
function er(e) {
  return Qn(e.animate) || Xu.some((t) => $n(e[t]));
}
function tr(e) {
...
function vr(e, t, n, r = !1) {
  ...
  (t.x < od && t.x > ad && (t.x = 1), t.y < od && t.y > ad && (t.y = 1));
}
function O(e, t) {
  ((e.min += t), (e.max += t));
}
...
function wr(e, t, n) {
  ...
  return (
    a && ((i = !1), (r += `rotate(${Tu(a, mu.pathRotation)}) `)),
    (r = r.trim()),
...
function Or(e) {
  for (let t in e) ((dd[t] = e[t]), pc(t) && (dd[t].isCSSVariable = !0));
}
function kr(e, { layout: t, layoutId: n }) {
  return (
    vl.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!dd[e] || e === `opacity`))
  );
}
function Ar(e, t, n) {
  let r = e.style,
...
function Pr(
  ...
  for (let e of gd) d[e] !== void 0 && ((f[e] = d[e]), delete d[e]);
  (t !== void 0 && (d.x = t),
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
...
function Fr(e, t, n, r) {
  Er(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(_d.has(n) ? n : un(n), t.attrs[n]);
}
function Ir(e, t, n) {
  let r = Ar(e, t, n);
  for (let n in e)
...
function qr(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.scale >= wd && e.scale <= Td) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= Dd && e.translate <= Od) || isNaN(e.translate)) && (e.translate = 0));
}
function Jr(e, t, n, r) {
...
function ni(e, t, n, r) {
  (ti(e.x, t, kd, n ? n.x : void 0, r ? r.x : void 0),
    ti(e.y, t, Ad, n ? n.y : void 0, r ? r.y : void 0));
}
function ri(e) {
...
function fi(e, t, n, r, i, a) {
  i
    ? ((e.opacity = q(0, n.opacity ?? 1, Pd(r))), (e.opacityExit = q(t.opacity ?? 1, 0, Fd(r))))
  ...
  for (let i = 0; i < jd; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || Nd(o) === Nd(s)
        ? ((e[a] = Math.max(q(Md(o), Md(s), r), 0)), (U.test(s) || U.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Ud++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            Hu.value && (Bd.nodes = Bd.calculatedTargetDeltas = Bd.calculatedProjections = 0),
            this.nodes.forEach(wi),
            this.nodes.forEach(Ni),
            this.nodes.forEach(Pi),
            this.nodes.forEach(Ti),
            Hu.addProjectionMetrics && Hu.addProjectionMetrics(Bd));
        }),
        ...
        (R.read(() => {
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              n && n(),
              (n = _i(i, 250)),
              zd.hasAnimatedSinceResize &&
                ((zd.hasAnimatedSinceResize = !1), this.nodes.forEach(Mi)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              let a = this.options.transition || i.getDefaultTransition() || Wd,
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          Hu.value && Bd.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        Hu.value && Bd.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = Ku()),
        (this.projectionDelta = Ku()),
        (this.projectionDeltaWithTransform = Ku()));
    }
    ...
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new Rd()),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Vd.length; t++)
        (yi(`rotate${Vd[t]}`, e, r, this.animationValues),
          yi(`skew${Vd[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      for (let t in dd) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = dd[t],
...
function ta() {
  if (cf) return;
  let e = {};
  for (let t in sf) e[t] = { isEnabled: (e) => sf[t].some((t) => !!e[t]) };
  (ir(e), (cf = !0));
}
function na() {
  return (ta(), ar());
...
function aa(e) {
  typeof e == `function` && (uf = (t) => (t.startsWith(`on`) ? !ia(t) : e(t)));
}
function oa(e, t, n) {
  let r = {};
  for (let i in e)
...
function da(e) {
  let { initial: t, animate: r } = ua(e, y(df));
...
function _a(e, t, r, i) {
  let a = n(() => {
    let n = hf();
    return (Pr(n, t, vd(i), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function va(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(gf.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
...
function $a(e) {
  let [t, n] = Zi(),
    r = y(As);
  return m(Lf, { ...e, layoutGroup: r, switchLayoutGroup: y(pf), isPresent: t, safeToRemove: n });
}
function eo(e, t, n) {
  let { props: r } = e;
...
function no({ root: e, ...t }) {
  ...
  let r = Uf.get(n),
    i = JSON.stringify(t);
  return (r[i] || (r[i] = new IntersectionObserver(Gf, { root: e, ...t })), r[i]);
}
function ro(e, t, n) {
  let r = no(t);
  return (
...
function ao(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > Qf ? 0 : Bs(i.current - s, l);
}
function oo(e, t, n) {
...
function co(e, t, n = 0) {
  let r = 0;
  if ((e in np && (e = np[e]), typeof e == `string`)) {
    let t = parseFloat(e);
    e.endsWith(`px`)
      ? (r = t)
      : e.endsWith(`%`)
...
function lo(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ? (i = [e, e])
      : typeof e == `string` &&
        ((e = e.trim()), (i = e.includes(` `) ? e.split(` `) : [e, np[e] ? e : `0`])),
    (a = co(i[0], n, r)),
    (o = co(i[1], t)),
    a - o
  );
...
function ho(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !op.has(t))) {
    ...
    (f.addEventListener(`resize`, r),
      t !== document.documentElement && sp.set(t, Vn(t, r)),
  ...
  return (
    ...
    () => {
      ...
      (op.delete(t),
        n &&
          (dp(t).removeEventListener(`scroll`, n),
          sp.get(t)?.(),
          f.removeEventListener(`resize`, n)));
      let r = up.get(t);
      (r && (z(r), up.delete(t)), lp.delete(t));
    }
  );
}
function go(e) {
  return f === void 0 ? !1 : e ? Al() : kl();
}
function _o(e) {
...
function bo(e) {
  ...
  for (let [t, n] of fp) if (yo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function xo(e) {
  let t = { value: 0 };
  return {
...
function ko(e, t) {
  return f === void 0 ? !1 : e ? Al() && !!bo(t) : kl();
}
...
function No(e) {
  ((Yl.current = []), e());
  let t = Mo(Yl.current, e);
  return ((Yl.current = void 0), t);
}
function Po(e, t, n, r) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if (
          (ee > 0 && yt(u, ee), c.length === 1 && c.unshift(null), m && `${m}${yp}`, m && m < yp)
        ) {
          let e = b > 0 ? _ / b : 0;
          b = qo(b, m, _);
          let t = [...c],
  ...
  return (
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        (c[0] !== 0 && (c.unshift(0), s.unshift(s[0]), l.unshift(vp)),
...
function fs(e) {
  return typeof e == `object` && !!e && yf in e;
}
function ps(e) {
  if (fs(e)) return e[yf];
}
...
function hs(e) {
  Yd.current && ((Yd.current.isUpdating = !1), Yd.current.blockUpdate(), e && e());
}
function gs() {
  return v(() => {
    let e = Yd.current;
...
function _s(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = xn(e),
    ...
    s = new IntersectionObserver(
      ...
      { root: n, rootMargin: r, threshold: typeof i == `number` ? i : wp[i] }
    );
...
function xs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: a, ...o }, s) {
  ...
  return m(l, {
    ...
    ref: h,
    ignoreStrict: !0,
    children: m(Dp.Provider, { value: p, children: e }),
  });
}
function Ss(e, t) {
...
function Cs() {
  if (Pp) {
    let e = Ts(Pp, `y`);
    e && (Np.delete(e), Mp.delete(e));
    let t = Ts(Pp, `x`);
    (t && t !== e && (Np.delete(t), Mp.delete(t)), (Pp = null));
  }
}
function ws(e, t) {
...
function Es(e, t, n) {
  ...
  if (o < kp) {
    let e = 1 - o / kp;
    return { amount: -Ap * e * e, edge: `start` };
  } else if (s < kp) {
    let e = 1 - s / kp;
    return { amount: Ap * e * e, edge: `end` };
  }
  ...
  return m(l, {
    ...
    onDrag: (e, t) => {
      let { velocity: r, point: a } = t,
        o = d[p].get();
      (g(n, o, r[p]), Ds(_.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Cs(), a && a(e, t));
    },
...
var As,
  ...
  Ip = t(() => {
    (o(),
      ...
      (sc = (e) => {
        if (ic(e)) {
          ...
          let [t, n, r, i] = e;
          return Ie(t, n, r, i);
        } else if (oc(e)) return (ac[e], `${e}`, ac[e]);
        return e;
      }),
      (cc = [
        `setup`,
      ...
      (V = {
        ...
        set: (e) => {
          ((dc = e), queueMicrotask(Be));
        },
      }),
      (fc = (e) => (t) => typeof t == `string` && t.startsWith(e)),
      (pc = fc(`--`)),
      (mc = fc(`var(--`)),
      (hc = (e) => (mc(e) ? gc.test(e.split(`/*`)[0].trim()) : !1)),
      (gc = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu),
      (_c = { test: (e) => typeof e == `number`, parse: parseFloat, transform: (e) => e }),
      (vc = { ..._c, transform: (e) => N(0, 1, e) }),
      (yc = { ..._c, default: 1 }),
      (bc = (e) => Math.round(e * 1e5) / 1e5),
      (xc = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu),
      (Sc =
        /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu),
      (Cc = (e, t) => (n) =>
        !!(
          (typeof n == `string` && Sc.test(n) && n.startsWith(e)) ||
          (t && !He(n) && Object.prototype.hasOwnProperty.call(n, t))
        )),
      (wc = (e, t, n) => (r) => {
        if (typeof r != `string`) return r;
        let [i, a, o, s] = r.match(xc);
        return {
          [e]: parseFloat(i),
          [t]: parseFloat(a),
          [n]: parseFloat(o),
      ...
      (Tc = (e) => N(0, 255, e)),
      (Ec = { ..._c, transform: (e) => Math.round(Tc(e)) }),
      (Dc = {
        test: Cc(`rgb`, `red`),
        parse: wc(`red`, `green`, `blue`),
      ...
      (Oc = { test: Cc(`#`), parse: Ue, transform: Dc.transform }),
      (kc = (e) => ({
      ...
      (Ac = kc(`vh`)),
      (jc = kc(`vw`)),
      (Mc = { ...U, parse: (e) => U.parse(e) / 100, transform: (e) => U.transform(e * 100) }),
      (Nc = {
        test: Cc(`hsl`, `hue`),
        parse: wc(`hue`, `saturation`, `lightness`),
      ...
      (G = {
        test: (e) => Dc.test(e) || Oc.test(e) || Nc.test(e),
        parse: (e) => (Dc.test(e) ? Dc.parse(e) : Nc.test(e) ? Nc.parse(e) : Oc.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? Dc.transform(e) : Nc.transform(e),
        getAnimatableNone: (e) => {
          let t = G.parse(e);
      ...
      (Vc = (e) => (typeof e == `number` ? 0 : G.test(e) ? G.getAnimatableNone(e) : e)),
      (Hc = (e, t) => (typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : Vc(e))),
      ...
      (Kc = (e, t) => {
        ...
        let i = { ...n };
        return (e) => (
          (i.red = Uc(n.red, r.red, e)),
          (i.green = Uc(n.green, r.green, e)),
          (i.blue = Uc(n.blue, r.blue, e)),
      ...
      (il = { decay: gt, inertia: gt, tween: Ct, keyframes: Ct, spring: mt }),
      (al = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (sl = class extends al {
        ...
        initAnimation() {
          ...
          s !== Ct &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Ls(ol, ot(o[0], o[1]))), (o = [0, 100]));
        ...
        play() {
          ...
          let { driver: e = rl, startTime: t } = this.options;
      ...
      (ul = {
        ...
        rotate: ll,
        rotateZ: ll,
        skewX: (e) => cl(Math.atan(e[1])),
        skewY: (e) => cl(Math.atan(e[2])),
        skew: (e) => (Math.abs(e[1]) + Math.abs(e[2])) / 2,
      }),
      (dl = (e) => ((e %= 360), e < 0 && (e += 360), e)),
      (fl = ll),
      (pl = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1])),
      (ml = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5])),
      (hl = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: ml,
        scale: (e) => (pl(e) + ml(e)) / 2,
        rotateX: (e) => dl(cl(Math.atan2(e[6], e[5]))),
        rotateY: (e) => dl(cl(Math.atan2(-e[2], e[0]))),
        rotateZ: fl,
        rotate: fl,
        skewX: (e) => cl(Math.atan(e[4])),
        skewY: (e) => cl(Math.atan(e[1])),
      ...
      (vl = new Set([..._l, `pathRotation`])),
      (yl = (e) => e === _c || e === W),
      (bl = new Set([`x`, `y`, `z`])),
      (xl = _l.filter((e) => !bl.has(e))),
      (Y = {
      ...
      (El = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Sl.add(this), Cl || ((Cl = !0), R.read(Nt), R.resolveKeyframes(Mt)))
        ...
        cancel() {
          this.state === `scheduled` && (Sl.delete(this), (this.state = `pending`));
        }
        resume() {
      ...
      (Dl = (e) => e.startsWith(`--`)),
      (Ol = {}),
      (kl = It(() => f.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Al = It(() => f.ViewTimeline !== void 0, `viewTimeline`)),
      (jl = It(() => {
        try {
      ...
      (Ml = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`),
      (Nl = {
        linear: `linear`,
        ease: `ease`,
        easeIn: `ease-in`,
      ...
      (Fl = { anticipate: Xs, backInOut: Ys, circInOut: $s }),
      (Il = 10),
      (Ll = class extends Pl {
        constructor(e) {
          (Ht(e),
        ...
        updateMotionValue(e) {
          ...
          let o = new sl({ ...a, autoplay: !1 }),
            s = Math.max(Il, V.now() - this.startTime),
            c = N(0, Il, s - Il),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && Ft(i, u, l),
      ...
      (Rl = new Set([`opacity`, `clipPath`, `filter`, `transform`])),
      (zl = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/),
      (Bl = new Set([
        `color`,
        `backgroundColor`,
        `outlineColor`,
      ...
      (Vl = Pe(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Hl = (e, t) =>
        t !== `zIndex` &&
        !!(
          typeof e == `number` ||
      ...
      (Wl = class extends al {
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          let d = {
              startTime: r
                ? this.resolvedAt && this.resolvedAt - this.createdAt > Ul
                  ? this.resolvedAt
                  : this.createdAt
                : void 0,
              finalKeyframe: t,
      ...
      (Xl = class {
        ...
        setCurrent(e) {
          ((this.current = e),
            ...
            this.canTrackVelocity === null &&
              e !== void 0 &&
              (this.canTrackVelocity = Jl(this.current)));
        }
        ...
        get() {
          return (Yl.current && Yl.current.push(this), this.current);
        }
        getPrevious() {
          return this.prev;
        }
        getVelocity() {
          let e = V.now();
          if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > ql)
            return 0;
          let t = Math.min(this.updatedAt - this.prevUpdatedAt, ql);
      ...
      (Zl = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 }),
      (Ql = (e) => ({
        type: `spring`,
        stiffness: 550,
      ...
      ($l = { type: `keyframes`, duration: 0.8 }),
      (eu = { type: `keyframes`, ease: [0.25, 0.1, 0.35, 1], duration: 0.3 }),
      (tu = (e, { keyframes: t }) =>
        t.length > 2 ? $l : vl.has(e) ? (e.startsWith(`scale`) ? Ql(t[1]) : Zl) : eu),
      (nu = new Set([
        `when`,
        `delay`,
        `delayChildren`,
      ...
      (ru =
        ...
        (o) => {
          ...
          return s.isSync ? new sl(u) : new Wl(u);
        }),
      (iu = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u),
      (au = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ..._l])),
      (ou = (e) => Array.isArray(e)),
      (X = (e) => !!(e && e.getVelocity)),
      (su = `framerAppearId`),
      (cu = `data-` + un(su)),
      (lu = (e) => (t) => t.test(e)),
      (uu = [_c, W, U, H, jc, Ac, { test: (e) => e === `auto`, parse: (e) => e }]),
      (du = (e) => uu.find(lu(e))),
      (fu = {
        rotate: H,
        pathRotation: H,
      ...
      (hu = new Set([`brightness`, `contrast`, `saturate`, `opacity`])),
      (gu = /\b([a-z-]*)\(.*?\)/gu),
      (_u = {
        ...K,
        getAnimatableNone: (e) => {
      ...
      (Cu = class extends El {
        ...
        readKeyframes() {
          ...
          for (let n = 0; n < e.length; n++) {
            let r = e[n];
            if (typeof r == `string` && ((r = r.trim()), hc(r))) {
      ...
      [...wu],
      (Tu = (e, t) => (t && typeof e == `number` ? t.transform(e) : e)),
      ({ schedule: Eu, cancel: Du } = ze(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      (Ou = (e, t) => (t ? e === t || Ou(e, t.parentElement) : !1)),
      (ku = (e) =>
        e.pointerType === `mouse`
          ? typeof e.button != `number` || e.button <= 0
          : e.isPrimary !== !1),
      (Au = new Set([`BUTTON`, `INPUT`, `SELECT`, `TEXTAREA`, `A`])),
      (ju = new Set([`INPUT`, `SELECT`, `TEXTAREA`])),
      (Mu = new WeakSet()),
      (Nu = (e, t) => {
      ...
      (Ru = Lu(`inline`, `width`, `offsetWidth`)),
      (zu = Lu(`block`, `height`, `offsetHeight`)),
      (Bu = new Set()),
      (Hu = { value: null, addProjectionMetrics: null }),
      (Uu = [...uu, G, K]),
      (Wu = (e) => Uu.find(lu(e))),
      (Gu = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 })),
      (Ku = () => ({ x: Gu(), y: Gu() })),
      (qu = () => ({ min: 0, max: 0 })),
      (Q = () => ({ x: qu(), y: qu() })),
      (Ju = new WeakMap()),
      ...
      (nd = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (Qu.current || rr(), (this.shouldReduceMotion = Zu.current)),
        ...
        bindToMotionValue(e, t) {
          if (
            ...
            t.accelerate && Rl.has(e) && this.current instanceof HTMLElement)
          ) {
      ...
      (rd = class extends nd {
        constructor() {
          (super(...arguments), (this.KeyframeResolver = Cu));
        }
      ...
      (fd = class extends rd {
        ...
        readValueFromInstance(e, t) {
          if (vl.has(t)) return this.projection?.isProjecting ? Ot(t) : gl(e, t);
          {
            let n = jr(e),
              r = (pc(t) ? n.getPropertyValue(t) : n[t]) || 0;
      ...
      (md = { offset: `stroke-dashoffset`, array: `stroke-dasharray` }),
      (hd = { offset: `strokeDashoffset`, array: `strokeDasharray` }),
      (gd = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`]),
      (_d = new Set([
        `baseFrequency`,
        `diffuseConstant`,
        `kernelMatrix`,
      ...
      (vd = (e) => typeof e == `string` && e.toLowerCase() === `svg`),
      (yd = class extends rd {
        constructor() {
          (super(...arguments),
            (this.type = `svg`),
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = _d.has(t) ? t : un(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Ir(e, t, n);
        }
        ...
        mount(e) {
          ((this.isSVGTag = vd(e.tagName)), super.mount(e));
        }
      }),
      (bd = Xu.length),
      (xd = [...Yu].reverse()),
      ...
      (Nd = (e) => typeof e == `number` || W.test(e)),
      (Pd = mi(0, 0.5, Qs)),
      (Fd = mi(0.5, 0.95, F)),
      (Id = (e, t) => e.depth - t.depth),
      (Ld = class {
        constructor() {
      ...
      (zd = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 }),
      (Bd = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 }),
      (Vd = [``, `X`, `Y`, `Z`]),
      (Hd = 1e3),
      (Ud = 0),
      (Wd = { duration: 0.45, ease: [0.4, 0, 0.1, 1] }),
      (Gd = (e) => s !== void 0 && s.userAgent && s.userAgent.toLowerCase().includes(e)),
      (Kd = Gd(`applewebkit/`) && !Gd(`chrome/`) ? Math.round : F),
      (qd = xi({
      ...
      (Jd = (e) => !e.isLayoutDirty && e.willUpdate(!1)),
      (Yd = { current: void 0 }),
      (Xd = xi({
        ...
        defaultParent: () => {
          if (!Yd.current) {
            let e = new qd({});
            (e.mount(f), e.setOptions({ layoutScroll: !0 }), (Yd.current = e));
          }
          return Yd.current;
        },
        resetTransform: (e, t) => {
      ...
      (Qd = ({
        ...
        return (
          ...
          m(Ns.Provider, { value: y, children: e })
        );
      }),
      ($d = (e) => e.key || ``),
      (ef = ({
      ...
      (nf = (e) => e === !0),
      (rf = (e) => nf(e === !0) || e === `id`),
      (af = ({ children: e, id: t, inherit: r = !0 }) => {
        let a = y(As),
          o = y(tf),
          [s, c] = ea(),
          l = i(null),
        ...
        l.current === null &&
          (rf(r) && u && (t = t ? u + `-` + t : u),
          (l.current = { id: t, group: (nf(r) && a.group) || Gi() }));
        let d = n(() => ({ ...l.current, forceRender: s }), [c]);
        return m(As.Provider, { value: d, children: e });
      }),
      (of = a({ strict: !1 })),
      (sf = {
        animation: [
    ...
    ((df = a({})),
      ...
      (pf = a({})),
      (mf = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} })),
      (hf = () => ({ ...mf(), attrs: {} })),
      (gf = [
        `animate`,
        `circle`,
      ...
      (_f = ff({ scrapeMotionValuesFromProps: Ar, createRenderState: mf })),
      (vf = ff({ scrapeMotionValuesFromProps: Ir, createRenderState: hf })),
      ...
      (Cf = { animation: { Feature: bf }, exit: { Feature: Sf } }),
      (wf = (e) => (t) => ku(t) && e(t, Aa(t))),
      (Tf = (e, t) => Math.abs(e - t)),
      (Ef = (e, t) => ((t.isSVG ?? va(e)) ? new yd(t) : new fd(t, { allowProjection: e !== l }))),
      (Df = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
      (Of = new Set([`auto`, `scroll`])),
      (kf = class {
        constructor(
          e,
          t,
        ...
        startScrollTracking(e) {
          ...
          for (; t;) {
            ...
            ((Of.has(e.overflowX) || Of.has(e.overflowY)) &&
      ...
      (Mf = class {
        ...
        start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
          ...
          this.panSession = new kf(
            ...
            { onSessionStart: i, onStart: a, onMove: o, onSessionEnd: s, resumeAnimation: c },
            {
              ...
              dragSnapToOrigin: l,
              distanceThreshold: n,
              contextWindow: Df(this.visualElement),
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (ln(this.visualElement, e), n.start(ru(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        addListeners() {
          if (!this.visualElement.current) return;
          jf.set(this.visualElement, this);
      ...
      (Rf = { pan: { Feature: Ff }, drag: { Feature: Nf, ProjectionNode: Xd, MeasureLayout: $a } }),
      (zf = class extends id {
        mount() {
        ...
        startObserver() {
          ...
          let { viewport: e = {} } = this.node.getProps(),
            ...
            a = {
              ...
              rootMargin: n,
              threshold: typeof r == `number` ? r : Kf[r],
            },
            o = (e) => {
      ...
      (Yf = { layout: { ProjectionNode: Xd, MeasureLayout: $a } }),
      (Xf = ka({ ...Cf, ...Jf, ...Rf, ...Yf }, Ef)),
      (Zf = { renderer: Ef, ...Cf, ...Jf }),
      { ...Zf, ...Rf, ...Yf },
      { ...Cf },
      (Qf = 50),
      ($f = () => ({
      ...
      (ep = () => ({ time: 0, x: $f(), y: $f() })),
      (tp = { x: { length: `Width`, position: `Left` }, y: { length: `Height`, position: `Top` } }),
      (np = { start: 0, center: 0.5, end: 1 }),
      (rp = [0, 0]),
      (ip = {
        Enter: [
          [0, 1],
      ...
      (lp = new WeakMap()),
      (up = new WeakMap()),
      (dp = (e) => (e === document.scrollingElement ? f : e)),
      (fp = [
        [ip.Enter, `entry`],
        [ip.Exit, `exit`],
        [ip.Any, `cover`],
      ...
      (pp = { start: 0, end: 1 }),
      (mp = new Map()),
      (hp = () => ({ scrollX: D(0), scrollY: D(0), scrollXProgress: D(0), scrollYProgress: D(0) })),
      (gp = (e) => (e ? !e.current : !1)),
      (_p = class extends Xl {
        constructor() {
        ...
        add(e) {
          (vl.has(e) || Rl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
      ...
      (vp = `easeInOut`),
      (yp = 20),
      (bp = (e) => typeof e == `number`),
      (xp = (e) => e.every(bp)),
      (Sp = us()),
      (Cp = ds),
      (wp = { some: 0, all: 1 }),
      (Tp = () => ({})),
      ff({ scrapeMotionValuesFromProps: Tp, createRenderState: Tp }),
      (Ep = {}),
      fe(Ep, { Group: () => Op, Item: () => Fp }),
      (Dp = a(null)),
      (Op = _(xs)),
      (kp = 50),
      (Ap = 25),
      (jp = new Set([`auto`, `scroll`])),
      (Mp = new WeakMap()),
      (Np = new WeakMap()),
      (Pp = null),
      (Fp = _(ks)));
...
//# sourceMappingURL=motion.jtMCvOiK.mjs.map
