...
import { S as f, a as p, r as re, t as ie } from "./motion.jtMCvOiK.mjs";
import {
  A as m,
  J as ae,
  L as h,
  ...
  me = e(() => {
    (d(),
      ...
      (N = c((e, t) => {
        ...
        return n ? s(f.div, { ...a, layoutId: r, ref: t }) : s(`div`, { ...a, ref: t });
      })),
...
e(() => {
  (d(),
    ...
    (W = m(U)),
    (G = m(F)),
    (K = x(F, { nodeId: `pBR1Ew0r8`, override: fe, scopeId: `PX9hIOIVM` })),
    (q = le(_(x(f.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (J = `framer-6jWyo`),
    ...
    (ye = ({ value: e, children: n }) => {
      ...
      return s(p.Provider, { value: a, children: n });
    }),
    (be = f.create(a)),
    ...
    (Q = y(
      c(function (e, t) {
        ...
        ae();
        let { style: l, className: d, layoutId: ee, variant: ne, ...p } = xe(e),
          {
            baseVariant: ie,
            classNames: m,
            ...
            setVariant: b,
            variants: x,
          } = oe({ defaultVariant: `HK2sXlagE`, ref: i, variant: ne, variantClassNames: Y }),
          S = Se(e, x),
          C = g(J);
        return s(re, {
          id: ee ?? a,
            ...
            children: s(ye, {
              ...
              children: s(ce, {
                ...
                children: u(q, {
                  ...
                  __targetOpacity: 1,
                  className: `${g(C, `framer-n0ccwk`, d, m)} framer-bmpgw8`,
    ...
    S(Q, [{ explicitInter: !0, fonts: [] }, ...W, ...G], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.BslH6ZUP.mjs.map
